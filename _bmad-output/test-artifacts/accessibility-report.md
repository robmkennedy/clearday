# Accessibility Report — BMad Todo
...
<html lang="en">                          ← 3.1.1 Language
  <body>
    <header>                               ← Landmark
      <h1>BMad Todo</h1>                   ← Heading hierarchy
...
| 2.4.2 Page Titled | Descriptive `<title>` | "BMad Todo" | ✅ |
| 2.4.3 Focus Order | Logical tab sequence | Verified in E2E | ✅ |
| 2.4.6 Headings and Labels | Descriptive headings | `<h1>BMad Todo</h1>`, `<h2>To Do</h2>`, `<h2>Done</h2>` | ✅ |
